...
export const fetchTodosThunk = createAsyncThunk('todos/fetchTodos', async ({ page, limit }: { page: number; limit: number }) => {
	const response = await fetchTodos(page, limit)
	return response
})

export const postTodoThunk = createAsyncThunk('todos/postTodo', async (text: string) => {
...
export const updateTodoThunk = createAsyncThunk('todos/updateTodo', async ({ id, data }: { id: number; data: Partial<Todo> }) => {
